...
function WaitForService {
  ...
  while ($ElapsedTime -lt $Timeout) {
    ...
    WriteLog -LogFile $LogFile -LogLevel "INFO" -Log "Service not running yet. Elapsed time: $ElapsedTime seconds..."
  }
  # If the loop exits without finding the service running
  WriteLog -LogFile $LogFile -LogLevel "ERROR" -Log "$ServiceName service is not running after waiting $Timeout seconds"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDMWBuIfP5cuJ60
# pqjfp98/s4/CmVg/j4ohS425fdU+OKCCGJkwggROMIIDNqADAgECAg0B7l8Wnf+X
...
# AQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIClx3ESx+S7bpvz3yCvE+HnewgfHKWVM
# EkVjNVom7mvuMA0GCSqGSIb3DQEBAQUABIICAMDwKGZbZTfzWUtLLK5fI+RLGtWY
# jEnEwxk/0NSBwMtegxo5R8JAhP38rZA7Rqg9xGurLebqfA5gttZdg2iLLE01QHBV
# LTdWScfG76RHNhbQiXk050Ca6ZoF/BsoX2mfSGbes3k5SfQ7nhDvAn2sEXrh8wpd
# GcJpQ3LdOZX55S+Kh9qhhmPTdfYaXqY+RMhYrmqpdnBazBvYG1V2WfulbwmCaC5l
# YHdEkBG0aWeqqrB8hhJVUe+zLrzOndjYkkrOjYpQ9A/ahooKEviddX6+k6NfRWm8
# ueT6Yj047UEKy/D6NFHlYnDnKUuE+q0CMyGX5cu+SOEXt/LRF9aOetJFtzArvRYj
# V+dKcp7Pt9y2kMTBHgsxMRxW+NBuifORFK9rIzhNNm8aSUNTpQv1kFD/9Oh4KK3q
# oDTzhy1ykQNXV50gDb62HKHNE4YEnzzjF5iKdMgbuiTC6av/knIYwV0fNvJfxZBL
# 9VMeEQb+Eak6UwZS2D7qHd6CrVIHcVro/lu+tHEJKldopO51a/Dw0Y5zWBUgbQ3s
# SN/60A+p15GJNWZ+b9Hw8BYnKbRIw2exizJYvTVrINp4DoYfQaPF9wox7xiTHx6r
# OeBzxbkZefwbCHTVtASVSggvNcMJXHVOJK8pKOc167L5HU26GUdcUjIqUNuOf5qA
# m9dd4M62qjqC4Y/ToYId7TCCHekGCisGAQQBgjcDAwExgh3ZMIId1QYJKoZIhvcN
# AQcCoIIdxjCCHcICAQMxDTALBglghkgBZQMEAgIwgeQGCyqGSIb3DQEJEAEEoIHU
# BIHRMIHOAgEBBgsrBgEEAaAyAgMCAjAxMA0GCWCGSAFlAwQCAQUABCAfobmjcTYq
# sleoAokk4m9BqDjQ2//9+okbMlYpUqA4rgIUcVAAjYTqqTt3ktlLDeYnAD4AK2kY
# DzIwMjYwNjE3MDg0NDM5WjADAgEBoF2kWzBZMQswCQYDVQQGEwJCRTEZMBcGA1UE
...
# BAICoQ0GCSqGSIb3DQEBDAUAMD8GCSqGSIb3DQEJBDEyBDCzmlu/eicNZz++NYWn
# zx5yYmOuMnTeEGLelPbZmSoIKHl6LZYPnIuEU7GhZgsCOVwwgbQGCyqGSIb3DQEJ
...
# Q0EgMjAyNQIRAIRyP8GVzBbx2yui9mDfK+QwDQYJKoZIhvcNAQEMBQAEggGAn5mE
# cZWUQnXJ2liX7y8jJruwJEuW4AXr5zwDyGKDvrKGal9tiumBLnJmAhDCm3BLtc0E
# wyZaYh2ShwHkA14BLO9UbNt7dfqBhE7YpuoH2rBeGt/t05pB3Ss2qnuMShRhkqkA
# mBQiA57QmWXICtSL5SG7Pii9Tsr4CfK5njU5Ga7mf4ZpFVVvAqHEicnFy0AzCaNT
# f+OIUI3MlTAorlCTYf3pjb/os2CCNLHOTUEWJJszuIS5xTq5ZCCdMjqLUGlAn+OJ
# vNnovSFtMso2hTwdfFwmaZnqq2j2rJ70M6PMTHW5yFec2WHo8IhgxXky+q6Yr0Zh
# UNlsffeUkdL2s7Fx40Lj/9GhonuoC85aC4f+idIUAM+GznGJY9uSzQoIIYUfBtBB
# /rYouvh9I9UMThPDuf3V4xTOBiS4kQjkCKotJjiwKrTnKey4OehDPKlYuKqNKWgg
# zgZdhaFNyB4LQz6+FqNYOMURtDU9wSwFbHAmcl7dt3SvzosYwnXPI2at3z+C

[CmdletBinding()]
param(
  [Parameter(Mandatory = $true)] [string]$VaultFilesBucket,
  [Parameter(Mandatory = $true)] [string]$LicenseFileKey,
  [Parameter(Mandatory = $true)] [string]$RecoveryPublicKey,
...
try {
  WriteLog -LogFile $LogFile -LogLevel "INFO" -Log "Retrieving Bucket Region"
  $BucketRegion = (Get-S3BucketLocation -BucketName $VaultFilesBucket -Region $Region).Value
  if (!$BucketRegion) # The Get-S3BucketLocation command will return $null when the region is us-east-1
  {
    $BucketRegion = 'us-east-1'
  } 
  WriteLog -LogFile $LogFile -LogLevel "INFO" -Log "Retrieving License"
  Read-S3Object -BucketName $vaultFilesBucket -Key $licenseFileKey -File C:\CyberArk\Deployment\vaultLicense.xml -Region $BucketRegion
  WriteLog -LogFile $LogFile -LogLevel "INFO" -Log "License retrieved successfully"
  WriteLog -LogFile $LogFile -LogLevel "INFO" -Log "Retrieving Recovery Key"
  Read-S3Object -BucketName $vaultFilesBucket -Key $recoveryPublicKey -File C:\CyberArk\Deployment\recoveryPublic.key -Region $BucketRegion
  WriteLog -LogFile $LogFile -LogLevel "INFO" -Log "Recovery Key retrieved successfully"
} catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD70zfnwH1TBXPX
# pQ0Pt1C84xpL3MShzG/ErnyfwKl3J6CCGJkwggROMIIDNqADAgECAg0B7l8Wnf+X
...
# AQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILe8UGqarzIpYpVa3LVHJhvWbuqUyCci
# 49N6PP8l5o6SMA0GCSqGSIb3DQEBAQUABIICAKy9e+/ktuAhv5gTlGsEw2KHgffk
# ybEB/+Fkr7ap5CDk5oBGDoY0l92F/UW1cRU9JbB2VvHicCYkuo81mivwU7hfkhvl
# dd/gU4eqfppc4CM4CFxRLEc6RVrX5/uFrnnaT6E1jTLxfvY432Y5O+vC6ejz8y3R
# k5ZsejCgA6jzCPkBSy2Hlc/HISyREru8orV0IDXt1I1wJzUBaRg0IjyN/JEnQsPr
# kLSFBT12jyVkCcruA9ipwKJpSiZ8Ko411IU1OFEWI6Vsut3M32zbUQlyFPxQYcV8
# 94pcFbxSXdfUYvKbQwEGjYtFFP+qubuEHqxgzzsatYGeoElfRJxq6xXz9czmw7+q
# Po5XwmULvMnR+PpyRIrmUUaEiUpBi9k92ieJJtXERHhSjzdFRVa2TWdlyX0PRMiw
# pnUsYGjgMGiwfS3ecAg2GoxPQTfZPTuiMVSoByUfijFlG4FPsMSbc0yRdquKORXL
# prF4yQnBFcxpv4xYgSNjtNpvv8ExsAmY1IRjx3GrCKA5TE4IjrCii4eTYxEY2bRN
# YyLiI2s3p+A29FJ8LgBMgHNUfCC1pm3Xy8qf2pp+9XFUe75ZGMn00aE6CeVNaR/J
# CSc/ItebBUS66MRUsI/5wV+q4Jkh8lMOx1EiTxAoaXXHEDtuKeOcE7si3zukXfYC
# bxkezHwbpe3K2DFioYId7TCCHekGCisGAQQBgjcDAwExgh3ZMIId1QYJKoZIhvcN
# AQcCoIIdxjCCHcICAQMxDTALBglghkgBZQMEAgIwgeQGCyqGSIb3DQEJEAEEoIHU
# BIHRMIHOAgEBBgsrBgEEAaAyAgMCAjAxMA0GCWCGSAFlAwQCAQUABCBCzr3fqRyG
# s1te5lPfhBkmSjyThWM2vPzyVYkyNK57CAIUI1vyMd2bSAXcpUSXzEudYe5PPB4Y
# DzIwMjYwNjE3MDg0NDIzWjADAgEBoF2kWzBZMQswCQYDVQQGEwJCRTEZMBcGA1UE
...
# BAICoQ0GCSqGSIb3DQEBDAUAMD8GCSqGSIb3DQEJBDEyBDAmQ/0kFgmyBUJBdsFQ
# nKi1bf/sKLNDjgRD6tlZbSoOJv3/K5/5hZ0D7x4PzDeQHbEwgbQGCyqGSIb3DQEJ
...
# Q0EgMjAyNQIRAIRyP8GVzBbx2yui9mDfK+QwDQYJKoZIhvcNAQEMBQAEggGApYNY
# Q8q/JfifIzTkpMvZN2YYyGszJGQbiwBwIm3dyu1vgLXA/V5tiPH/TQTmx5hbJBRt
# nxtr4sXw7NMOLS28+3h9z1OL8ofd09dtodMR81mLZHHgtENW3n6noyh6Q9o2ADs2
# VNULqWf3Qz/SqFiDSdknTifbCTXXgpVyw2zA6U+OrNTXGZc7pkokuBdcxoROOYuV
# pSEtXO6zsyY48n0iqvRxFWkObk/dCEj7CpdBvFObYad5xipoUsaRFGRTHW6GBeEL
# +8UgQZaxyKK/A8vVaoH6nhpUcUaA0gYnrpt/Uos+zQCfuOUgoE8+Jsq63evyqbjJ
# eHeoWc7PiA2wv0WX3YgJ2Gn2c90Wvs60cqXe3ZzEq6JgUsUVehLB2vQWBeMr/9zE
# X5v/bBPI3KunCkvtbtFeYPtAB/iWktRGr0poE8OKxuLnY5vIxUqvrLpZIsrtAImi
# 774TBNJhJ7qXVClvZ/2ZJo0eEdvlQHtH9skQR2E+dSEcp5l6rg1QE5S7RAS8

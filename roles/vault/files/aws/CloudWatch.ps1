...
try {
  ...
  $updatedContent = $configContent `
    ...
    -replace 'VAULTINIT_LOG_PH',       $VaultInitLogStream `
    -replace 'VAULTPOST_LOG_PH',       $VaultPostInstallLogStream
  ...
  Write-Error "Error configuring CloudWatch Agent: $_"
  exit 1
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC/lWzMEXJlaVPn
# PK0p9lqx+JTQi9kRpXNgCQjBhrBCFqCCGJkwggROMIIDNqADAgECAg0B7l8Wnf+X
...
# AQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIF3BvRXDwrm4OGtycD/V9p3R713Wtk7r
# DD8wAqyPY5dfMA0GCSqGSIb3DQEBAQUABIICAHfksLZJgWNthrmPbuMYFE7v7gOa
# KHnpX0GksR187t8XgIUqy7zYWXAaFOE9yiDrobef3Zm6U1Jpf43k+0c+Em8FStc5
# 29MCx7flqJgJPnWEAlUYW+LaonWZctk/wDPaYm3sE5fw6eLPa1+A7IeESvAchKQS
# GMgficLMPZosbS/j0/NEggUy+eolF1huYZ7bYZ7ZAaEOt429qe4TWr3F/t83vOZh
# bYSZ0mEx6/RnccH9GN5REzpJZHs9wJUpK0/AQzRKkaRipoKUdxRLTGpsuQhTCNDQ
# tzgxxzdxZoQMclONjfQuGhD9TMCftTVDFDcQjSGW/Hhhy/cQE5lQ6NsQaXylEPSC
# ebXeefyFkMdZdh26Zc3TSA8DmqNzQ3FEWXiRHg8Up69yyatwlwp0m9a8tVRFIL0n
# VfDqlIBWyO6Qsw+NAKsvU+7bu9pmEmE8IeCm0QHHYhJc9Rd3izEfEe5JmJh4WZoO
# wq/qJfiFDzAYa3AVR0R745N2yXVwZmo1bqqnOKYPGFqlI8mhdqBPPNIsm+vboy4q
# sPJTzRUjK0s8R8mPbGXfD167inZDQwD8Iz5TmWpwYjA/R+RU4OojzJvzigBgMkCS
# RimhaPqvk2wF3aL7Xg0k53g24eNCGaqFezs6tro+POlVQ3nz6RSUP5Vx0vGosZMb
# Dbyoywrhb+tR0QTeoYId7TCCHekGCisGAQQBgjcDAwExgh3ZMIId1QYJKoZIhvcN
# AQcCoIIdxjCCHcICAQMxDTALBglghkgBZQMEAgIwgeQGCyqGSIb3DQEJEAEEoIHU
# BIHRMIHOAgEBBgsrBgEEAaAyAgMCAjAxMA0GCWCGSAFlAwQCAQUABCBx8J3nMGm2
# rWwzGV/cL10eQs29/clfrNZSw93Z4Ed0hgIUAedVzrPRGbSX0OcZ1tfNeCJyR1gY
# DzIwMjYwNjE3MDg0NDE2WjADAgEBoF2kWzBZMQswCQYDVQQGEwJCRTEZMBcGA1UE
...
# BAICoQ0GCSqGSIb3DQEBDAUAMD8GCSqGSIb3DQEJBDEyBDBs+9mlaKnjMy7Hja7a
# Eg9FVFh3XmcdOE5Jscl4DHQxDaKySSLvXlZ/1Ec5JKoJrvgwgbQGCyqGSIb3DQEJ
...
# Q0EgMjAyNQIRAIRyP8GVzBbx2yui9mDfK+QwDQYJKoZIhvcNAQEMBQAEggGAK2Fe
# NTtrqCR3eLwTDo2LJUIAHjc/MYF8eBDB0vsUpDtyXNcm/5nHqhTQ1N/TxSc+t9zl
# Iv4f3YT2Eju8EjSk8CfD0t/AbbcEdaRxvfVCh19Fm42VDPgfi2o19BxwFDDPiS3y
# T/khLwMWHZDtVzBRp3TXBnN56fynQGcNxEI67LRAadSJbCafVbeGw730NVGIp9Se
# kjrC37VfGTbprGbWLnN+//iIrUI03sRl121j+qA5SjN3tHm+3hiPYhjx6BpaFdbT
# S/uWHroREdoGro64TQmR8XSMFuWS0FK8Ao5WxtM71AZvW4jXIEo7obapyV2zWVV6
# n8hsSLZ56r14Kz9FIEnK3UtpVZqqTixJAv5y3cfCtdHFg+3TznnU35KBZyoNIzpD
# iLg+2DUxThys6Sad1UB32LMq6pnxVeWsxzDg9cd4+yg7tJIRbLoavPCxmn4blJgV
# NCwd2Amltu/xPI7nhB7TWFEna1cV/dTOhC/nFeIEH3nyWeb6bPdgQLDumWOz

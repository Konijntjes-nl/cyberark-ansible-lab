### Remove firewall rules to ensure hardening
try {
    Get-NetFirewallRule -All |
    Where-Object { $_.Group -NotMatch 'CYBERARK' } |
    ForEach-Object { Write-Output "$($_.Group)"
      Remove-NetFirewallRule -Group "$($_.Group)"
    }
} catch {
  exit 1
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCruyQ8lvamQzPg
# KWobf0P2lISf5w83Aoe+XsqXXSLiTaCCGJkwggROMIIDNqADAgECAg0B7l8Wnf+X
...
# AQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOx+GdlCpvE0Nl1iMt5pGwiL5P0WiOuY
# olw7O1Sk8OOwMA0GCSqGSIb3DQEBAQUABIICAI+nL8EGKGRliu/rMMgYdlF6ZNrd
# 3SvveH1I+1Ze/KofGPXSwVjwNfdKw+la5az49xZbu+AMu3HtuHxSL7Gv0Y83vFxt
# Y7ZqFHTJQWz6Sv7bcxpPfQBtJ4M3yN4jWLVsMRcVo59TrXta8ARy3K1Q3tecToEi
# V+Q/RXaZ3oWuUOoHfslhQd742k2rYql3h935cT4HURQDC9WAe73E3MLjqF9simjG
# 5DieSVJH6ib5QbwRTpvCvKwEEvDOnt8nNOFNGAVo+NWrD4y8w9JhcpSZ8oZ0lO3/
# RYI29mJkQREKO/NF/vtK22QaJrKCvDj5WzSDoSMd89PHUn4941SNZfwfm7A3p9xF
# 2HPL1rYHWsn6tFRiNzh8r9nzsV48xM3xaDG1zjgP8d9oC3vcitAQqA1nbRXdZx8v
# U0WVsHD9d80CQJVWAbLzmFYWrC7ttQTO2JLtIlPVMv1PJjp18JKzDXQYdmteob1D
# Wy0kjXcMZ2q7PLhOnGItSO8P6zwaScaU03PZonF4+9KJd/DW/YZx0/PYwpOSFo00
# /t+r5zKR+J0UhE4Kdkgr6ylGFrk2rdaLNasH+5SdhNTsj6EsvAUALqKehI/vqIUl
# R5M0L8TWZ11m4DbNje489ZLQ5DXNrUxJQRzosUtXLoplJKttZbKetfoQyL2aH57S
# DM5fRqkWaT6i2IY1oYId7TCCHekGCisGAQQBgjcDAwExgh3ZMIId1QYJKoZIhvcN
# AQcCoIIdxjCCHcICAQMxDTALBglghkgBZQMEAgIwgeQGCyqGSIb3DQEJEAEEoIHU
# BIHRMIHOAgEBBgsrBgEEAaAyAgMCAjAxMA0GCWCGSAFlAwQCAQUABCA82kqUrbrV
# nhn3m8avDCgYl5p06Bghyqwxy0GR327LvQIUUh/LX+nOpqHoi99Y4HuGRgWKFHYY
# DzIwMjYwNjE3MDg0NDI3WjADAgEBoF2kWzBZMQswCQYDVQQGEwJCRTEZMBcGA1UE
...
# BAICoQ0GCSqGSIb3DQEBDAUAMD8GCSqGSIb3DQEJBDEyBDC6yyGJCPE+e0ZOt4L3
# yZL04cTYdv7uvuy/gMVPHNtLKta/jtBkssR1hGguh2mjzCIwgbQGCyqGSIb3DQEJ
...
# Q0EgMjAyNQIRAIRyP8GVzBbx2yui9mDfK+QwDQYJKoZIhvcNAQEMBQAEggGAwEI6
# 0ZAT0QELH0+6xgynCsOkZ143LyZ/0etChH6cE2xehrHJBnm5+he5jYCGpsOP45pr
# Q1qjlV3XOFHpyESJRKJV97viAQamFYy4qVZnTtYbOUk2scJrJKS90R3Qunej8q6w
# q8WnNWbOghK6B12HUSKlGrk1IYZgIxYYn4Ka2MA1ZN+gIxm/mdx6nrY6YeAN8uXZ
# WLzeCyVmKef0/rH3u+9qN4ROOJgOvKUoZzTVNPWdXxTfWVcmAtQdY3vhEd/eS0Yu
# iICC4ETfX0SntlFkHDWJeZdqCD0WwLJGqkqVznEnkO/byVhvV2YWcLL1sSW2IQG2
# 7HvJSO0nI4MeQshH/FulNpRNSA+BS6Q9AysSZKUVWeVVekrXTc9oLWWyRcTfYQ1Y
# haT/eBBN620VjuSFACH4EOz93NWqnCJzsCRO1Fi6u33GBL3s7a3aE2eiLJ60e6tA
# HLNjQVolrRyWViLDjiS5sXf3OUPzkbIQ0EPjuGP6XB4Y5NXo/8HcBbFzuFPc
